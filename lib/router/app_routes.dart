...
class AppRoutes {
  ...
  static final menuOptions = <MenuOption>[
    ...
    MenuOption(route: '/listView', name: 'InfiniteScrol & Pull to refresh', screen: const ListviewBuilderScreen(), icon: Icons.list),
    ...
    MenuOption(route: '/slider', name: 'Slider Screen', screen: const SliderScreen(), icon: Icons.shape_line_rounded),
  ];
